          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-white/40 shadow-sm mb-8 w-fit">
                ...
                <span className="text-xs font-bold text-gray-600 uppercase tracking-wider">Top Rated Pet Shop</span>
              </div>
            ...
            >
              {hero.subtitle} Experience the joy of bringing home a healthy, happy puppy from a trusted source.
            </motion.p>
            ...
            >
              <Button size="lg" onClick={handleCtaClick} className="h-16 px-10 rounded-full text-lg shadow-2xl shadow-orange-500/30 hover:shadow-orange-500/50 hover:scale-105 transition-all duration-300">
                Meet Puppies <MessageCircle className="ml-2" size={24} />
              </Button>
              <Button size="lg" variant="ghost" onClick={() => window.open(contact.socials.instagram, '_blank')} className="h-16 px-8 text-lg hover:bg-white/50">
            ...
            >
               <div>
                 <p className="text-4xl font-bold text-gray-900 font-serif">500+</p>
                 <p className="text-sm text-gray-500 uppercase tracking-wide mt-1">Happy Families</p>
               </div>
               <div>
                 <p className="text-4xl font-bold text-gray-900 font-serif">100%</p>
                 <p className="text-sm text-gray-500 uppercase tracking-wide mt-1">Health Check</p>
               </div>
            </motion.div>
          </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Vaccinated & Healthy</p>
                    </div>
                  </div>
                </motion.div>
             </motion.div>
